...
public class keyHandler implements KeyListener {
	...
	} // Key typed not used in this program. Its for when the user inputs a character, while keyPressed is for when a key is pressed. 
	...
	public void keyPressed(KeyEvent e) {
		...
		// There are many integers associated with many key codes (list online) (ie: 10 -- Enter)
		...
		// GAME WIN STATE
		else if (gp.gameState == gp.gameWinState) {gameWinState(code);}
